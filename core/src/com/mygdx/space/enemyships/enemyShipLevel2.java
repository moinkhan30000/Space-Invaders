...
public class enemyShipLevel2 {
    private int DOWNWARD = -2;
    private int level;
    private int posX;
    private int posY;
    ...
    public enemyShipLevel2(int type, float downward) {

        if (type == 1) {
            enemyShip = new Texture("enemyL2T1.png");
        }
        if (type == 2) {
            enemyShip = new Texture("enemyL2T2.png");
        }
        if (type == 3) {
            enemyShip = new Texture("enemyL2T3.png");
        }
